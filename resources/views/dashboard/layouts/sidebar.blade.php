<div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="#" target="_blank">
        <span class="ms-1 font-weight-bold">Klasifikasi Gizi</span>
    </a>
</div>
...
<div class="collapse navbar-collapse w-auto " id="sidenav-collapse-main">
        ...
        @if (auth()->user()->is_admin == 1)
            ...
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('dashboard/hasil-training') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Hasil Training</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('dashboard/data-anak') ? 'active' : '' }}"
    ...
    <form method="post" action="{{ route('logout') }}">
        @csrf
        <button type="submit" class="btn btn-danger ms-3 mt-3">Logout</button>
    </form>
</div>
